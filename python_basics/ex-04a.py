...
message = "Thanks!"  # set the default message
if number < 0:
    # change message only when number less than 0
    message = "Number is too small, it must be zero or more"
elif number > 100:
    # change message only when number greater than 100
    message = "Number is too big, it must be 100 or less"
print(message)
